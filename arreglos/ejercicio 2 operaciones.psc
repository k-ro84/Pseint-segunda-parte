//2. Realizar un programa que lea 10 números reales por teclado, los almacene en un arreglo y muestre 
//por pantalla la suma, resta y multiplicación de todos los números ingresados al arreglo.
